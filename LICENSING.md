...
A `LICENSE-gpt-researcher` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher), Copyright
the assafelovic/gpt-researcher authors, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../gpt-researcher-port/specs/SPEC-001-gpt-researcher.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
